...
compararlos** (ver el paper en [`extras/FD_VDV.pdf`](extras/FD_VDV.pdf)).
...
└── extras/FD_VDV.pdf        # paper de referencia
```
...
> ⚠️ **Estado actual:** scaffold. La geometría de la ruta periódica y la E/S están implementadas y
> testeadas; el paso de simulación (R1–R4) y las reglas de colisión son *stubs* a completar
> con TDD (ver hitos en el documento de diseño). `mvn test` pasa en verde con lo ya implementado.
...
python3 run_matrix.py --help     # orquesta el barrido (N × p × variante × realizaciones)
```
...
- [~] Hito 1 — Scaffolding (este commit)
