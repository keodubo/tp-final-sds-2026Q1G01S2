...
\begin{itemize}
  ...
  (ASCENDING, los más lentos primero), decreciente (DESCENDING, los más
  rápidos primero) y aleatorio (RANDOM).
\end{itemize}
...
\includegraphics[width=0.48\linewidth]{N5_p01_CONTACTO_PURO_FIXED_N_r1_fotograma.png}\hfill
\includegraphics[width=0.48\linewidth]{N30_p01_CONTACTO_PURO_FIXED_N_r1_fotograma.png}
\caption{Fotogramas en régimen a baja densidad ($N=5$, izquierda) y a saturación
($N=30$, derecha), contacto puro, $p=0{,}1$. Color según velocidad. Links a animaciones
al publicar.}
...
\begin{figure}[h]\centering
\includegraphics[width=0.32\linewidth]{INC_p01_CONTACTO_PURO_ASCENDING_r1_fotograma.png}\hfill
\includegraphics[width=0.32\linewidth]{INC_p01_CONTACTO_PURO_DESCENDING_r1_fotograma.png}\hfill
\includegraphics[width=0.32\linewidth]{INC_p01_CONTACTO_PURO_RANDOM_r1_fotograma.png}
\caption{Fotogramas del protocolo incremental para los órdenes creciente, decreciente y
aleatorio (contacto puro, $p=0{,}1$). Links a animaciones al publicar.}
\label{fig:anim-inc}
\end{figure}
