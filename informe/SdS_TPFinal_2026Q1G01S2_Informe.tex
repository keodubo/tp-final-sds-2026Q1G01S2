...
\begin{itemize}
  ...
  no-solapamiento duro, así que \emph{deliberadamente} no reproduce esa cola: su distribución de
  ...
  realidad admite solapamiento pero en el modelo es imposible. El estudio de sensibilidad
  (Sec.~\ref{sec:sensibilidad}) muestra que, para $N\le25$, cambiar $L$ de $1320$ a $1313\unit{mm}$
  no altera la curva ($\le0{,}03\unit{mm/s}$): el efecto de $L$ es sólo geométrico. El punto de
  saturación $N=30$ sólo existe a $L=1320$ (a $1313$, $30\ell=5280>5252$ celdas no entran).
  ...
  \item \textbf{Forma de la distribución de velocidad.} El modelo reproduce la tendencia de
  angostamiento y corrimiento con $N$, pero no la forma: su distribución es un conjunto de deltas cuantizadas
...
\begin{itemize}
  ...
  solapamiento ni la forma detallada de la distribución (Sec.~\ref{sec:limitaciones}).
  ...
  saturación (Sec.~\ref{sec:limitaciones}).
